...
int main() {
    ...
    cout << "the coefficient of x^3 in p1 = " << p1.coefficient_of_k(3)
         << endl; // 3.2
    cout << "the coefficient of x^4 in p1 = " << p1.coefficient_of_k(4)
         << endl;                                                       // 0.0
    ...
    cout << "the next term of x^1 of p3 = " << p3.next_term(1)
         << endl; // 0, there is not next term of x
    cout << "the result of p1 when x is 1.5 = " << p1.eval(1.5)
         << endl; // 3.2 * (1.5)^3 + 4.5 * 1.5 - 2.0 = 15.6
    cout << "the result of p1 when x is 0 = " << p1.eval(0)
         << endl; // 3.2 * 0^3 + 4.5 * 0 - 2.0 = -2.0
    ...
    polynomial p4 = p1 + p2; // p4 = 3.2x^3 + 4.5x - 2.0 - 3.2x^3 + 2.0x^2 - 5.0
                             // = 2.0x^2 + 4.5x -7.0
    cout << "p4 = p1 + p2 = ";
    p4.show_contents();
    ...
    p4 = p1 * p2;
    /* p4 = (3.2x^3 + 4.5x - 2.0) * (- 3.2x^3 + 2.0x^2 - 5.0)
    ...
    p4 -= p2; // p4 = 3.2x^3 + 4.5x + 5.2 - (- 3.2x^3 + 2.0x^2 - 5.0)
              // = 6.4x^3 - 2.0x^2 + 4.5x + 10.2
    cout << "p4 -= p2 = ";
    p4.show_contents();

    p4 -= p3; // p4 = 6.4x^3 - 2.0x^2 + 4.5x + 10.2 - 0.0
              // = 6.4x^3 - 2.0x^2 + 4.5x + 10.2
    cout << "p4 -= p3 = ";
    p4.show_contents();
    ...
    p4 *= p3;
    /* p4 = (20.5x^6 - 6.4x^5 + 43.2x^4 + 10.8x^3 + 24.2x^2 + 36.9x - 20.4) * 0
          = 0.0 */
    cout << "p4 *= p3 = ";
    p4.show_contents();
